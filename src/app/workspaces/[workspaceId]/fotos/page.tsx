...
export default async function FotosSelecionarObraPage({ params }: Params) {
  ...
  return <ObraSelectorRedirect workspaceId={workspaceId} obras={obras} destinoSufixo="fotos" titulo="Registro Fotográfico" />;
}
