...
export default async function CopiasControladasSelecionarObraPage({ params }: Params) {
  ...
  return <ObraSelectorRedirect workspaceId={workspaceId} obras={obras} destinoSufixo="copias-controladas" titulo="Cópias Controladas" />;
}
