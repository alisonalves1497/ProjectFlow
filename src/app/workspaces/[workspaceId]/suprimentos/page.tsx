...
export default async function SuprimentosSelecionarObraPage({ params }: Params) {
  ...
  return <ObraSelectorRedirect workspaceId={workspaceId} obras={obras} destinoSufixo="suprimentos" titulo="Suprimentos" />;
}
